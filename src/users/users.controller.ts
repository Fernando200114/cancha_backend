import { Controller, Get, Post, Put, Delete, Body, Param, UseGuards, Query, BadRequestException, UploadedFile, UseInterceptors } from '@nestjs/common';
...
export class UsersController {
    ...
    async update(@Param('id') id: string, @Body() updateUserDto: UpdateUserDto) {
        const user: User | null = await this.usersService.update(id, updateUserDto);
        return new SuccessResponseDto('Users retrieved', user);
    }
